...
$(function() {
  var $ = Agora.jQuery;
  $('[data-toggle=stop-ticket-sale]').click(function(e) {
    e.preventDefault();
    ...
    swal({
      title: "Are you sure?",
      text: "Any tickets you have already sold of this type will be unaffected.",
      type: "warning",
      showCancelButton: true,
      confirmButtonClass: "btn-danger",
      confirmButtonText: "Yes, stop sales",
      closeOnConfirm: false,
      confirmButtonClass: "btn-danger",
    },
    function(isConfirmed){
      if (isConfirmed) {
        window.location = Urls.ticket_type_stop_sale(event_id, ticket_type_id);
      }
    });
  })

  $('[data-toggle=delete-ticket-type]').click(function(e) {
    e.preventDefault();
    var ticket_type_id = $(this).data('ticket-type-id');
    var event_id = $(this).data('event-id');
    ...
    swal({
      title: "Are you sure?",
      text: "This will delete the ticket type.",
      type: "warning",
      showCancelButton: true,
      confirmButtonClass: "btn-danger",
    ...
    function(isConfirmed){
      if (isConfirmed) {
        window.location = Urls.delete_ticket_type(event_id, ticket_type_id, redirect_to);
      }
    });
  });
});

/* Simple formatter for sort code fields, repurposed from formance code base
https://github.com/omarshammas/jquery.formance/blob/master/lib/jquery.formance.js
*/
...
// Make sure selected tab is kept open on refresh
// Modified from http://stackoverflow.com/questions/18999501/bootstrap-3-keep-selected-tab-on-page-refresh
//
// Make sure we don't try navigating if the anchor starts with `/` since that's
// React-router's format and clashes with bootstrap's tabs
